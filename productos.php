...
if (!empty($_POST)) {
    ...
    if (empty($codigo) || empty($producto) || empty($tipo) || empty($modelo) || empty($proveedor)  || empty($precio) || $precio <  0 || empty($cantidad) || $cantidad <  0) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO producto(codigo,descripcion,precio,existencia,id_lab,id_modelo,id_tipo, vencimiento) values ('$codigo', '$producto', '$precio', '$cantidad', $proveedor, $modelo, $tipo, '$vencimiento')");
                if ($query_insert) {
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tbl">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($conexion, "SELECT p.*, t.id, t.tipo, pr.id, pr.nombre FROM producto p INNER JOIN tipos t ON p.id_tipo = t.id INNER JOIN modelo pr ON p.id_modelo = pr.id");
